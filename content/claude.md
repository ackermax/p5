...
- **"Mithral" is the spelling — settled.** It is the **D&D spelling of the metal** (Tolkien's is "mithril"), checked as a proper-noun spellcheck at the user's direction 2026-09-02. The Flint Rock relic (S70) is **the tip of a mithral spear**. Session files render it **"mythral" (Var)** and **"Mythril" (Jaak)**; the vault uses **mithral** in its own voice and leaves each player's file in their own words.
- **Ulfgardian relics can be *earned*, not only taken** (S70). At **Flint Rock** the **Elk tribe survives only as spirits, and they negotiate** — they asked the party's intentions and set a condition: **the blessing of [[The Golden Stag]]**. The Stag questioned each PC on **what they had done to restore nature's balance**, found them **"wanting but far enough along,"** and blessed them **because the breaking of [[The Ordening]] is itself a disruption of that balance**. **This is durable campaign canon: a power of nature has a stake in the Ordening spine.** The vault treats Flint Rock as the **counter-example to the Stone Stand robbery (S69)** and the model for Raven Rock.
- **The S70 blessings are symbolic — confirmed.** The **Golden Stag's blessing** and the **Elk spirits' blessing** carry **no mechanical effect**. Do **not** write them up as a resource, buff, or item. Their value is **standing**: two Ulfgardian parties and a power of nature judged the party and vouched for them — **credentials to invoke at a diplomacy mound like Raven Rock**.
- **[[Yartar]] entry procedure (S70):** you are **stopped outside the walls by a magical ward**, sent to **check in at the guard tower**, and **searched for dangerous items in the guardhouse** before being admitted. **The Waterbaron of Yartar is [[Nestra Ruthiol]]** (named S70, not yet met); **"Oversword" is a Yartar guard rank** (**[[Oversword Vaelia Thann]]** ran the party's check). The party **passed while carrying five giant relics, a 100 lb giant's skull and the Sword of Heavens** — so **the ward is not a blanket magic screen**; what it actually catches is unknown.
- **The [[Ignitamis]] refuels in [[Yartar]]** (S70) — an **older gnome** there took the ship to **fill the tank and make repairs**. This is the **first confirmed oil source**. **He gave no name** — don't keep prompting for one; he is findable only by returning to where the ship was left. **The price, the timeline, and how much range a full tank buys are still unrecorded.**
- **⭐ [[Clint]] and "Lamin" are the same man** — **confirmed 2026-09-02**: one merchant under two names. **[[Clint]] is the file; "Lamin" is an alias** in its frontmatter, and the old Lamin profile (fedora and coat, high charisma, **red-and-white wagon with a black dove**, the [[Goldenfields]] → Beliard → [[Everlund]] route, the Beliard customers) now lives there. **Consequence the vault states plainly: the man who sold [[Sevembra]] the [[The Cursed Seeds|cursed seeds]] is the merchant the party shops with** — most recently in [[Everlund]], S69, purchases still un-itemized. *(The [[Original Notes - Raw Archive (Through Session 55)|raw archive]] keeps the "Lamin" name as written — it is preserved source material and is never rewritten.)*
