---
tags: [lore, items, index]
---

# Items & References

> Magical items, mundane-but-important objects, combat references, and other "knows-but-doesn't-fit-elsewhere" notes.
...
### Party Resources
- **The Flint Rock relic — the tip of a mithral spear** *(S70)* — **only the tip.** Given **freely** by the **spirits of the Elk clan** at [[Ulfgardian Mounds|Flint Rock]] once we earned **[[The Golden Stag]]'s blessing**. *(**Mithral** — the D&D spelling for the metal. Players' files render it "mythral" / "Mythril".)* **Whether the tip is a usable item or purely a relic to spend is unrecorded** — see [[Gather Ulfgardian Relics]].
- **⭐ Two blessings — symbolic, no mechanical effect** *(S70, confirmed)* — **[[The Golden Stag]]'s blessing** (given for being *"wanting, but far enough along"* on restoring nature's balance) and **the blessing of the spirits of the Elk Tribe** (given with the relic). **They don't *do* anything.** What they are is **standing with the Ulfgardian dead and with a power of nature** — worth invoking at [[Ulfgardian Mounds|Raven Rock]], not worth a line on a character sheet.
...
## Items Of Interest (Not Ours Yet)

- **Conch of teleportation** — most giant leaders have one. **Bound to giants** — won't work for us. Cannot reach the Maelstrom anyway.
- **Cloud giant relic** in the **Black Tower** of [[Waterdeep]] — [[Vajra Safahr]] can guide us; [[Harrick Stonequill]] found it
- **Statue of [[Memnor]]** — held by [[Mulara and Nimbolo]]
- **[[Ulfgardian Mounds|Ulfgardian relics]]** — for **sacrifice to the oracles** in exchange for Ordening answers
- **Bowgentle's spellbook** — see [[Quest For The Spellbook]]
- **Brutal Falchion ("Ruin to Giants")**
- **Talon** — sword originally owned by **[[Aldith Tresendar]]** (Black Hawk); more info at [[Other Locations|Candlekeep]]
...
- **Fish Scale Smithy** — Waterdeep
- **Brian the Swordmaster** — in **Tradesward** of Waterdeep
- **Castle Tarm** — Hantanus Tarm's family estate; near Yawning Portal, two roads up, close to the market

## Combat References

### Yellow Slime
- **Immune:** Lightning, Slashing
- **Immune conditions:** Blinded, Charmed, Deafened, Exhaustion, Frightened, Prone
- **Resists:** Acid

### Troll (Wyvern Tor encounter)
- **Weak to:** Fire and acid (to prevent regen)
- Encountered with 5 orcs

## Deities / Higher Powers

- **The Watcher** — god of [[Helm's Hold]]
- **Uthgar (Ulfguard)** — god of strength; once mortal; slew [[Gurt]]
- **[[Memnor]]** — cloud giant deity ("The Masked Lord") and mythological first cloud giant; followed by the "Masked Ones"
- **[[Stronmaus]]** — cloud giant deity in our campaign (canonically the storm giant god); sky, clouds, weather, joy
...
- [[Other Locations|Conyberry]]: arrived with **4 hours left**
