...
# Minor Contacts (Index)

Quick-reference page for NPCs we've met but don't have detailed notes on yet. Promote any of these to a full note when they become important.

## Phandalin

- **Toblin Stonehill** — proprietor of the **Stonehill Inn**. Wife **Trelina**.
- **Pipin & Laura** — at the Stonehill Inn.
- **Mayor Harbin** — "a tool"; gave us the orc quest at [[Other Locations|Wyvern Tor]] *(quest resolved)*
- **Barthens** — shopkeeper. Wife **Thelmira**.
- **Qelyne** — mother of **Carp Alderleaf**
- **Daran Edermath** — elf, famous adventurer; lives in the **orchard**; **distinguished member of the [[Other Locations|Order of the Gauntlet]]**. Gave us the [[Old Owl Well]] quest. Knows [[Agatha]] the banshee.
- **Garret** — [[The Red Brands|Red Brand]] lieutenant; refused to admit he was the leader. (Defeated.)
- **Flint Oakwood** — "has the deed" (deed to what? Confirm with DM.)
- **Flint** — man in a bar (Phandalin). Possibly the same as Flint Oakwood, possibly different.
- **Mirna** — was held prisoner in Tresendar Manor; from **[[Thundertree]]**; wants help recovering her **heirloom** (alchemist's house, plague-marked) — quest open.
- **Koleen** — overheard the drow conversation about the Red Brands.
...
- **Leenard of [[Other Locations|Neverwinter]]** — nobleman met in the clothes store
- **Billin Omenhow** — maker of luxurious wagons

## Waterdeep

- **[[Commander Hawkwinter]]** — Waterdeep military; **[[Xanathars Guild|Xanathar]] wants him dead** (S59). *Promoted to his own file — see [[Commander Hawkwinter]].*
...
- **The Tarm Nephew** — at the gambling den; family of [[Hantanus Tarm]]
...
- **Lillia** — maid in Beliard; involved in the disappearance case
- **Alzar** — stableman in Beliard
...
- **Alaris** — wood elf guide from [[Other Locations|Ardeep]]
- **Analin** — elvish guide from Ardeep
- **Morok** — dwarven leader of the town (where exactly TBD)

## Red Larch

- **Lynch** — collected debts for us; veteran friend of Lady Daggerford
- **Yalantha** — boarding house; **owed Lynch 20 gp** (collected)
- **Eldres Tantour** — smithy near marketplace; **owed Lynch 20 gp** (collected)
- **Proprietor of the Swinging Sword Inn** — **owed Lynch 50 gp** (collected)
...
- We met "servants of [[Bahamut]]" in [[Other Locations|Kryptgarden Forest]] wearing white robes with platinum dragons — they were **actually evil**, just hiding behind Bahamut iconography. Encountered while investigating with the **Through&True investigative team** (gold thief case).
...
- **[[Tsernoth]]** — in [[Other Locations|Iriaebor]]; holds [[Bowgentle]]'s spellbook (per [[Agatha]])
- **[[Bowgentle]]** — legendary spellcaster whose book we're hunting
- **[[Jaheira]]** — Harper hero in Baldur's Gate; took down the Cult of Bhaal there

## Ulfgardian Chieftains

See [[Ulfgardian Mounds]] for full context.
